#include "get_my_courses_view.hpp"
...
namespace {
class GetMyCoursesView final
    : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-v1-get-my-courses";
  ...
  std::string HandleRequestThrow(
    ...
    auto result = course_administration::get_my_courses(token_id.value(),pg_cluster_);
...
void AppendGetMyCoursesView(
    userver::components::ComponentList& component_list) {
  component_list.Append<GetMyCoursesView>();
}
