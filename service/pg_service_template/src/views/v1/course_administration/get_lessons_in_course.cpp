#include "get_lessons_in_course.hpp"
...
namespace {
class GetLessonsInCourseView final
    : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-v1-course-get-lessons";

  GetLessonsInCourseView(
  ...
  std::string HandleRequestThrow(
    ...
    auto result = course_administration::get_lessons(
        course_id, pg_cluster_);
...
void AppendGetLessonsInCourseView(
    userver::components::ComponentList& component_list) {
  component_list.Append<GetLessonsInCourseView>();
}
