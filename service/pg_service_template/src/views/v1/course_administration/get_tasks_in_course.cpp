#include "get_tasks_in_course.hpp"
...
namespace {
class GetTasksInCourseView final
    : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-v1-course-get-tasks";

  GetTasksInCourseView(
  ...
  std::string HandleRequestThrow(
    ...
    auto result = course_administration::get_tasks(course_id, pg_cluster_);
...
void AppendGetTasksInCourseView(
  ...
  component_list.Append<GetTasksInCourseView>();
}
