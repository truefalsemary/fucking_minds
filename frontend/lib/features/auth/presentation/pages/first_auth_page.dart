...
class FistAuthPage extends StatelessWidget {
  const FistAuthPage({super.key});
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          AuthButton(inputText: 'Продолжить', onPressed: () => ()),
          const SizedBox(height: heightBetweenElements),
          AuthButton(inputText: 'Зарегистрироваться', onPressed: () => ()),
        ],
      ),
    );
  }
