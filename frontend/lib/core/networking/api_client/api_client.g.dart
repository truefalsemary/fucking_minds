...
class _ApiClient implements ApiClient {
  ...
  Future<List<Course>> getCourses() async {
    ...
    final _options = _setStreamType<List<Course>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<Resource>> getCourseMaterials(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Resource>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<void> deleteCourseLessonTaskStudentInspector(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/v1/course/{id}/lesson/${lessonId}/task/${taskId}/student/${studentId}/inspector',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<Resource> getMaterial(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Resource>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<Task> getTask(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Task>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<void> setCourseInspectors(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/v1/course/${courseId}/set_inspectors',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> setCourseInspector(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/v1/course/${courseId}/lesson/${lessonId}/task/${taskId}/student/${studentId}/inspector',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> sendSolution(
    ...
    final _options = _setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/v1/course/${courseId}/send_solution',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
